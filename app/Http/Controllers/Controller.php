...
class Controller extends BaseController
{
    ...
    public function checkGeneralColumn($params)
    {
        ...
        elseif ($params === 'name:updated_by') {
            $params = 'name:updated_by|label:Diperbarui|width:130px';
        }
        elseif ($params === 'name:updated_at') {
            $params = 'name:updated_at|label:Diperbarui|width:130px';
        }
        ...
        if (isset($params['type'])) {
            switch ($params['type']) {
                ...
                case 'show':
                    ...
                    $settings['url']     = rut($this->data['routes'].'.show', $params['id']);
                    break;
                ...
                case 'edit':
                    ...
                    $settings['url']     = rut($this->data['routes'].'.edit', $params['id']);
                    break;
                ...
                case 'delete':
                    ...
                    $settings['url']     = rut($this->data['routes'].'.destroy', $params['id']);
                ...
                case 'activate':
                    ...
                    $settings['url']   = rut($this->data['routes'].'.activate', $params['id']);
                            ...
                            if (!empty($item['type'])) {
                                ...
                                switch ($item['type']) {
                                    ...
                                    case 'edit':
                                        ...
                                        $default['url'] = rut($this->prepared('routes').'.edit', $item['id']);
                                        break;
                                    case 'print':
                                    ...
                                    case 'excel':
                                        ...
                                        $default['label'] = 'Cetak';
                                        $default['url'] = rut($this->prepared('routes').'.excel', $item['id']);
                                        $default['class'] = '';
                                        $default['attrs'] = 'target="_blank"';
                                        break;
                                    case 'download':
                                        ...
                                        $default['url'] = rut($this->prepared('routes').'.download', $item['id']);
                                        $default['class'] = '';
                                        $default['attrs'] = 'target="_blank"';
                                        break;
                                    case 'delete':
                                        ...
                                        $default['url'] = rut($this->prepared('routes').'.destroy', $item['id']);
                                        if(!empty($item['text'])) {
