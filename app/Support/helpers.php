...
function rut($name, $parameters = [], $absolute = true)
{
    if (in_array(env('APP_ENV'), ['production', 'staging'])) {
        return str_replace('10.11.12.219', 'audit.spi.tirtapatriot.net', app('url')->route($name, $parameters, $absolute));
    }
...
function yurl($path = null, $parameters = [], $secure = null)
{
    ...
    return str_replace('10.11.12.219', 'audit.spi.tirtapatriot.net', app(UrlGenerator::class)->to($path, $parameters, $secure));
}
