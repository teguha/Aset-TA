...
@section('modal-body')
	<div class="form-group row">
		...
		<div class="col-sm-12 parent-group">
			...
			<div class="form-text text-muted">*Parent berupa Divisi & SBU</div>
		</div>
	</div>
	<div class="form-group row">
		<label class="col-sm-12 col-form-label">{{ __('Kode') }}</label>
		<div class="col-sm-12 parent-group">
			<input type="text" name="code_manual" value="{{ $record->code_manual }}" class="form-control" placeholder="{{ __('Kode') }}" disabled>
		</div>
	</div>
	<div class="form-group row">
