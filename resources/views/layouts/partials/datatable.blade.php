	...
	<div class="card-body">
		...
		<div class="table-responsive">
		    @if(isset($tableStruct['datatable_1']))
			    <table id="datatable_1" class="table table-bordered table-hover is-datatable" style="width: 100%;" data-url="{{ isset($tableStruct['url']) ? $tableStruct['url'] : rut($routes.'.grid') }}" data-paging="{{ $paging ?? true }}" data-info="{{ $info ?? true }}">
			        <thead>
			            <tr>
