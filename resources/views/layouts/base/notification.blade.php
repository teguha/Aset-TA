@if (isset($notifications) && count($notifications))
    <div class="navi navi-hover scroll my-4 user-notification-items"
        ...
        @foreach ($notifications as $item)
            <a href="{{ rut('ajax.userNotificationRead', $item->id) }}"
                class="navi-item base-content--replace {{ $loop->last ? 'mb-7' : '' }}"
                data-url="{{ rut('ajax.userNotificationRead', $item->id) }}">
                <div class="navi-link">
    ...
    <div class="text-center">
        ...
        <a href="{{ rut('setting.profile.notification') }}" class="btn btn-light-primary mb-3 base-content--replace">
