    ...
    <div class="card card-custom mb-5">
        <div class="card-header">
            <div class="card-title">
                ...
                <h4 class="card-label">Detail Sertifikasi<small>({{ $record->name }})</small></h4>
            </div>
            <div class="card-toolbar">
                <a href="{{ rut($routes . '.sertifikasi.detailCreate', $record->id) }}"  data-placement="bottom" class="btn btn-primary base-modal--render" data-modal-backdrop="false" data-modal-v-middle="false" data-modal-size="modal-md"><i class="fas fa-plus"></i>
