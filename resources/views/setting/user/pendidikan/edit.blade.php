...
@section('action', rut($routes.'.pendidikan.detailUpdate', $detail->id))
...
@section('modal-body')
    ...
    <div class="form-group row">
		...
		<div class="col-sm-9 parent-group">
			<input type="text" name="institute" class="form-control" placeholder="{{ __('Institusi Pendidikan') }}" value="{{$detail->institute}}">
		</div>
	</div>
    <div class="form-group row">
		<label class="col-sm-3 col-form-label">{{ __('Tahun Lulus') }}</label>
		<div class="col-sm-9 parent-group text-left">
			<input type="text" name="thn_lulus" class="form-control base-plugin--datepicker-3 width-200px mr-auto text-left" placeholder="{{ __('Tahun Lulus') }}" value="{{$detail->thn_lulus}}">
		</div>
	</div>
    <div class="form-group row">
