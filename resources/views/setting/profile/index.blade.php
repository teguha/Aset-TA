                ...
                <form action="{{ rut($routes.'.updateProfile') }}" method="post" autocomplete="off">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url({{ '/'.('assets/media/users/blank.png')  }})">
                                    <img class="image-input-wrapper show" style="background-image: url({{ yurl('storage/'.auth()->user()->image)}})">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <input type="text" value="{{ auth()->user()->position->location->name ?? '' }}" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-xl-3 col-lg-3 col-form-label text-right">{{ __('Jabatan') }}</label>
                            <div class="col-lg-9 col-xl-6">
                                <input type="text" value="{{ auth()->user()->position->name ?? '' }}" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="row">
