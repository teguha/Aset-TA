	...
	<div class="card card-custom card-stretch gutter-b chart-finding-wrapper">
		<div class="card-header h-auto py-3">
			<div class="card-title">
				<h3 class="card-label">
					<span class="d-block text-dark font-weight-bolder"><?php echo e(__('Temuan')); ?></span>
				</h3>
			</div>
			<div class="card-toolbar" style="max-width: 500px;">
				<form id="filter-chart-finding"
					action="<?php echo e(rut($routes.'.chartFinding')); ?>"
					class="form-inline"
					role="form">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="input-daterange input-group text-nowrap">
								...
								<input type="text" class="form-control finding_start"
									name="finding_start"
									value="<?php echo e(request()->finding_start ?? date('Y') - 5); ?>"
									style="">
								...
								<input type="text" class="form-control finding_end"
									name="finding_end"
									value="<?php echo e(request()->finding_end ?? date('Y')); ?>"
									style="">
							</div>
						</div>
						<div class="col-md-6 col-sm-12">
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\PROJECT WEB\project-asset\resources\views/dashboard/_chart-finding.blade.php ENDPATH**/ ?>