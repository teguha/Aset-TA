	...
	<div class="card card-custom card-stretch gutter-b chart-followup-wrapper">
		<div class="card-header h-auto py-3">
			<div class="card-title">
				<h3 class="card-label">
					<span class="d-block text-dark font-weight-bolder"><?php echo e(__('Tindak Lanjut Temuan')); ?></span>
				</h3>
			</div>
			<div class="card-toolbar" style="max-width: 500px;">
				<form id="filter-chart-followup"
					action="<?php echo e(rut($routes.'.chartFollowup')); ?>"
					class="form-inline"
					role="form">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="input-daterange input-group text-nowrap">
								...
								<input type="text" class="form-control followup_start"
									name="followup_start"
									value="<?php echo e(request()->followup_start ?? date('Y') - 5); ?>"
									style="">
								...
								<input type="text" class="form-control followup_end"
									name="followup_end"
									value="<?php echo e(request()->followup_end ?? date('Y')); ?>"
									style="">
							</div>
						</div>
						<div class="col-md-6 col-sm-12">
							<select name="followup_object"
								...
								data-url="<?php echo e(rut('ajax.selectObject', [
									'category' => 'all',
									'optstart_id' => 'all',
									'optstart_text' => __('Objek'),
								])); ?>"
								data-placeholder="<?php echo e(__('Objek')); ?>">
								<option value=""><?php echo e(__('Objek')); ?></option>
							</select>
						</div>
					</div>
				</form>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\PROJECT WEB\project-asset\resources\views/dashboard/_chart-followup.blade.php ENDPATH**/ ?>