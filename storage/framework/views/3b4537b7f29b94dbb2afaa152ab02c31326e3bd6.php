	...
	<div class="row">
		...
		<div class="ml-4 pb-2" style="width: 350px">
			<select class="form-control filter-control base-plugin--select2-ajax"
				data-url="<?php echo e(rut('ajax.selectStruct', 'parent_group')); ?>"
				data-post="parent_id"
...
<?php echo $__env->make('layouts.lists', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT WEB\project-asset\resources\views/master/org/subsection/index.blade.php ENDPATH**/ ?>